...
// // 4.
// // this is s nive title -> This Is a Nice Title
// const convertTitleCase = function (title) {
//   const capitalize = str => str[0].toUpperCase() + str.slice(1);

//   const expections = ['a', 'an', 'the', 'but', 'or', 'on', 'in'];
...
// console.log(convertTitleCase('this is a nive title'));
// console.log(convertTitleCase('this is a LONG title but NOT t long'));
//
//
//
//
...
dogs.find(function (dog) {
  if (dog.owners.includes('Sarah') && !checkEatingOkay(dog)) {
    console.log(
